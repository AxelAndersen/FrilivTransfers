...
namespace AO.FrilivTransfers
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceProvider ConfigureApplicationService(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<CatalogSettings, CatalogSettings>();
            services.AddSingleton<CommonSettings, CommonSettings>();
            ...
            services.AddSingleton<IRepository<AclRecord>, EfRepository<AclRecord>>();
            services.AddSingleton<ICacheManager, MemoryCacheManager>();
            services.AddSingleton<IStaticCacheManager, MemoryCacheManager>();
            services.AddSingleton<IMemoryCache, MemoryCache>();            
            services.AddSingleton<IDataProvider, SqlServerDataProvider>();
            services.AddSingleton<IDateRangeService, DateRangeService>();
            services.AddSingleton<ILanguageService, LanguageService>();
            services.AddSingleton<ILocalizationService, LocalizationService>();
            services.AddSingleton<IProductAttributeParser, ProductAttributeParser>();
            services.AddSingleton<IProductAttributeService, ProductAttributeService>();
            services.AddSingleton<IStoreMappingService, StoreMappingService>();
            ...
            containerBuilder.Register(context => new NopObjectContext(context.Resolve<DbContextOptions<NopObjectContext>>())).As<IDbContext>().InstancePerLifetimeScope();
            containerBuilder.RegisterType<DbContextOptions<NopObjectContext>>().As<DbContextOptions<NopObjectContext>>();
            containerBuilder.RegisterType<EfRepository<CrossSellProduct>>().As<IRepository<CrossSellProduct>>();
            containerBuilder.RegisterType<EfRepository<Product>>().As<IRepository<Product>>();
            containerBuilder.RegisterType<EfRepository<ProductPicture>>().As<IRepository<ProductPicture>>();
            containerBuilder.RegisterType<EfRepository<ProductReview>>().As<IRepository<ProductReview>>();
            containerBuilder.RegisterType<EfRepository<ProductWarehouseInventory>>().As<IRepository<ProductWarehouseInventory>>();
            containerBuilder.RegisterType<EfRepository<RelatedProduct>>().As<IRepository<RelatedProduct>>();
            containerBuilder.RegisterType<EfRepository<StockQuantityHistory>>().As<IRepository<StockQuantityHistory>>();
            containerBuilder.RegisterType<EfRepository<StoreMapping>>().As<IRepository<StoreMapping>>();
            containerBuilder.RegisterType<EfRepository<TierPrice>>().As<IRepository<TierPrice>>();            
            containerBuilder.Register(context => EngineContext.Current.Resolve<IWorkContext>()).As<IWorkContext>().InstancePerLifetimeScope();
